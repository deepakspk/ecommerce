...
import { H1_CLASS, CARD_CLASS, INPUT_CLASS, FILTER_BAR_CLASS, FILTER_FIELD_CLASS, FILTER_FIELD_SM_CLASS } from "../../utils/ui";
    ...
    <div className="p-4 sm:p-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          {!loading && <p className="text-sm text-gray-400 mt-0.5">{total} product{total !== 1 ? "s" : ""}</p>}
        </div>
        <Link
