...
export default function ProductDetailPage() {
  ...
  const { finalPrice, hasDiscount, discountPercent } = getEffectivePricing(displayPrice, product);
    ...
    <div className={PAGE_CLASS}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-start bg-white rounded-2xl shadow-sm border border-gray-100 p-6 lg:p-8">
        ...
        <div className="space-y-5">
          ...
          {/* Warranty */}
          {product.warranty && (
            <div className="inline-flex items-center gap-2 bg-gray-50 text-gray-700 text-sm font-medium px-3 py-1.5 rounded-full border border-gray-200">
              <svg className="w-4 h-4 text-brand-600 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
